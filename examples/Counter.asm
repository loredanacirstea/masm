...
... */
  mstore(0x40, 0x60)
    /* "counter.sol":109:165  constructor() public {
... */
...
... */
    ...
    tag_1:
      ...
      dup1
      revert
        /* "counter.sol":242:301  function add(uint256 v) public {
... */
/* sig"function add(uint v) public" */
    tag_2:
    ...
    tag_6:
      stop
      /* sig"function getCounter() public view returns (uint)" */
